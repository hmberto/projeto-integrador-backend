...
public class PharmaciesAnonDB {
	public static String NAME = PharmaciesAnonDB.class.getSimpleName();
	private static Logger LOG = Logger.getLogger(PharmaciesAnonDB.class.getName());
