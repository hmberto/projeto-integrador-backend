...
public class UpdateAddress {
	public static String NAME = UpdateAddress.class.getSimpleName();
	private static Logger LOG = Logger.getLogger(UpdateAddress.class.getName());
	
	public static void updateAddress(Map<String, String> variables, UpdateUsers user, String lat, String lon, String addressId) {
		...
		try {
			...
			LOG.log(Level.INFO, "User address updated at address table! Address ID: " + addressId);
			
			LOG.exiting(NAME, "updateAddress");
		}
		catch (Exception e) {
