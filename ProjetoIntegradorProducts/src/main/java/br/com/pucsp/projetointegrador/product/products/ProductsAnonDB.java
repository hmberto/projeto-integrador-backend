...
public class ProductsAnonDB {
	public static String NAME = ProductsAnonDB.class.getSimpleName();
	private static Logger LOG = Logger.getLogger(ProductsAnonDB.class.getName());
	
	public StringBuffer getProducts(Map <String, String> variables, String distance, String lat, String lon) {
