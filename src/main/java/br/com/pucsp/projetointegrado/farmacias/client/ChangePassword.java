...
import br.com.pucsp.projetointegrado.farmacias.client.password.ChangePasswordDB;
...
public class ChangePassword {
	...
	public boolean changePass(Map<String, String> variables, ChangePass pass, int SESSION_LENGTH) {
